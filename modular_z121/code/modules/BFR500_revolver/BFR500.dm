/obj/item/gun/ballistic/revolver/single
	...
	accepted_magazine_type = /obj/item/ammo_box/magazine/internal/cylinder/ber500
...
/obj/item/ammo_box/magazine/internal/cylinder/ber500
	name = "ber500 cylinder"
	ammo_type = /obj/item/ammo_casing/c357
	caliber = CALIBER_357
	max_ammo = 5

/obj/item/ammo_box/ber500
	name = "BER-500 快速装弹器"
	desc = "BER-500专用装弹器，它的大小非常大，就像是秤砣一样"
	icon = 'modular_z121/icons/obj/guns/bfr500.dmi'
	icon_state = "loader"
...
/obj/item/gun/ballistic/revolver/c38/detective/item_interaction(mob/living/user, obj/item/tool, list/modifiers)
	if (istype(tool, /obj/item/ammo_box/ber500))
