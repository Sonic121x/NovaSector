...
/datum/status_effect/bluespace_grounded/on_apply()
	...
	to_chat(owner, span_warning(LANG("datum.1b154107a8f5138b", null)))
	return TRUE
...
/datum/status_effect/bluespace_grounded/on_remove()
	...
	to_chat(owner, span_notice(LANG("datum.acbfce7743005849", null)))
...
/datum/status_effect/bluespace_grounded/proc/on_teleport(mob/living/teleportee, atom/destination, channel)
	...
	to_chat(owner, span_holoparasite(LANG("datum.e8d0980b7739bada", null)))
	penalize()
...
/datum/status_effect/bluespace_grounded/proc/on_jaunt(mob/living/jaunter)
	...
	to_chat(owner, span_holoparasite(LANG("datum.1296e30aaf74def0", null)))
	penalize()
