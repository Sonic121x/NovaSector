...
/obj/item/storage/box/papersack/update_desc(updates)
	...
	switch(design_choice)
		if("Grey")
			desc = LANG("obj.af880cc27a5af9f4", null)
		if("Black")
			desc = LANG("obj.197f7bc5b0329338", null)
		if("Sec")
			desc = LANG("obj.baa4b39c3f54c046", null)
		if("Medical")
			desc = LANG("obj.830e4508b3db56dc", null)
		if("Fox")
			desc = LANG("obj.3a6ae854cabf00c8", null)
		if("Bunny")
			desc = LANG("obj.226066a5f92a1de6", null)
		else
			icon = initial(icon)
	return ..()
