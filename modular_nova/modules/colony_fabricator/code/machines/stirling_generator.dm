...
/obj/machinery/power/stirling_generator/examine(mob/user)
	. = ..()
	. += span_notice(LANG("obj.39a3ff4b85ba6035", null))
	. += span_notice(LANG("obj.0b312feac86ad375", null))
	. += span_notice(LANG("obj.eb56e19a2001fd4c", list(display_power(current_power_generation, convert = FALSE))))
	. += span_notice(LANG("obj.d5a3996142187ca4", list(display_power(max_power_output, convert = FALSE), max_efficient_heat_difference)))
