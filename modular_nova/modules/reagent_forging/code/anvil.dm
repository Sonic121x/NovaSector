/obj/structure/reagent_anvil
	name = "锻造铁砧"
	desc = "本质上就是一大块金属，你可以在上面锤打其他金属，对于任何手工加工金属的人来说都至关重要。"
...
/obj/structure/reagent_anvil/examine(mob/user)
	. = ..()
	. += span_notice("你可以使用<b>钳子</b>将<b>炽热的金属物体</b>放在这上面。")
	. += span_notice("可以通过<b>右键点击</b>来（解除）固定它")
...
/obj/structure/reagent_anvil/onZImpact(turf/impacted_turf, levels, message = TRUE)
	...
	poor_target.visible_message(
		span_bolddanger("[src]砸在[poor_target]身上，把他们压扁了！"),
		span_userdanger("你被[src]压扁了！")
	)
