...
ADMIN_VERB(try_stop_delam, R_ADMIN, "解离紧急停止", "Activate the delam suppression system.", ADMIN_CATEGORY_EVENTS)
...
ADMIN_VERB(toggle_delam_suppression, R_FUN, "解离抑制开关", "Disable/enable the delam suppression system.", ADMIN_CATEGORY_EVENTS)
