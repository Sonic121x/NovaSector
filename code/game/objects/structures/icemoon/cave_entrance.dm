...
/obj/structure/spawner/ice_moon/proc/destroy_effect()
	...
	visible_message(span_bolddanger(LANG("obj.68dbd2a7128549ab", list(src))))
...
/obj/effect/collapsing_demonic_portal/Initialize(mapload)
	...
	visible_message(span_bolddanger(LANG("obj.88dd813477f6e3f6", list(src))))
...
/obj/effect/collapsing_demonic_portal/proc/drop_loot()
	visible_message(span_warning(LANG("obj.08102e154fe11a84", list(src))))
	var/loot = rand(1, 100)
	switch(loot)
		if(1 to 80)
