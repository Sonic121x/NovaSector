...
/obj/item/mod/module/tether/used()
	if(HAS_TRAIT_FROM(mod.wearer, TRAIT_TETHER_ATTACHED, REF(src)))
		balloon_alert(mod.wearer, "已经系好了！")
...
/obj/item/mod/module/mister/atmos
	name = "MOD树脂喷雾器模块"
	desc = "一款具有净化效果的树脂喷雾器，能够迅速修复污染区域。"
