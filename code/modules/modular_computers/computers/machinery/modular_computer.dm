...
/obj/machinery/modular_computer
	name = "模块化电脑"
	desc = "一台高级电脑的框架" //This should only show up when building a computer, it should examine the processor instead
