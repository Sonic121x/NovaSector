...
ADMIN_VERB_ONLY_CONTEXT_MENU(cmd_admin_pm_context, R_NONE, "私信生物", /mob)
...
ADMIN_VERB(cmd_admin_pm_panel, R_NONE, "管理员私信", "Show a list of clients to PM", ADMIN_CATEGORY_MAIN)
