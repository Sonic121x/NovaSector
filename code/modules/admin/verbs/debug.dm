...
ADMIN_VERB(reload_paper_blanks, R_DEBUG, "重新加载空白纸", "Reloads photocopier paper blank templates (config/blanks.json and config/nova/blanks.json) from disk without restarting the server.", ADMIN_CATEGORY_DEBUG)
