...
/datum/unit_test/breath/breath_sanity/Run()
	...
	lab_rat.breathe()
	TEST_ASSERT(!lab_rat.failed_last_breath && !lab_rat.has_alert(ALERT_NOT_ENOUGH_OXYGEN), "人类无法从标准初始气体混合物的地砖上获得充足的呼吸")
	...
	lab_rat.breathe()
	TEST_ASSERT(!lab_rat.failed_last_breath && !lab_rat.has_alert(ALERT_NOT_ENOUGH_OXYGEN), "人类无法从标准氧气罐中获得充足的呼吸")
	...
	lab_rat.breathe()
	TEST_ASSERT(lab_rat.failed_last_breath && lab_rat.has_alert(ALERT_NOT_ENOUGH_OXYGEN), "人类在氧气罐空置时应窒息")
	...
	TEST_ASSERT(source.toggle_internals(lab_rat) && !isnull(lab_rat.internal), "Plasmaman toggle_internals() failed to toggle internals")
	lab_rat.breathe()
	TEST_ASSERT(lab_rat.failed_last_breath && lab_rat.has_alert(ALERT_NOT_ENOUGH_OXYGEN), "人类在纯氮气罐中应窒息")
...
/datum/unit_test/breath/breath_sanity_plasmamen/Run()
	...
	TEST_ASSERT(source.toggle_internals(lab_rat) && !isnull(lab_rat.internal), "Plasmaman toggle_internals() failed to toggle internals")
	lab_rat.breathe()
	TEST_ASSERT(!lab_rat.failed_last_breath && !lab_rat.has_alert(ALERT_NOT_ENOUGH_PLASMA), "等离子人无法从标准等离子罐中获得完整呼吸")
	...
	TEST_ASSERT(source.toggle_internals(lab_rat) && !isnull(lab_rat.internal), "Plasmaman toggle_internals() failed to toggle internals")
	lab_rat.breathe()
	TEST_ASSERT(lab_rat.failed_last_breath && lab_rat.has_alert(ALERT_NOT_ENOUGH_PLASMA), "等离子人在氧气罐空置时应窒息")
	...
	TEST_ASSERT(source.toggle_internals(lab_rat) && !isnull(lab_rat.internal), "Plasmaman toggle_internals() failed to toggle internals")
	lab_rat.breathe()
	TEST_ASSERT(lab_rat.failed_last_breath && lab_rat.has_alert(ALERT_NOT_ENOUGH_PLASMA), "人类在纯氮气罐中应窒息")
...
/datum/unit_test/breath/breath_sanity_ashwalker/Run()
	...
	lab_rat.breathe()
	TEST_ASSERT(!lab_rat.has_alert(ALERT_NOT_ENOUGH_OXYGEN), "灰烬行者无法从熔岩地初始气体混合物（在地砖上）中获得完整呼吸")
